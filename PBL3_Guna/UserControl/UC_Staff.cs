...
namespace PBL3_Guna
{
    public partial class UC_Staff : UserControl
    {
        ...
        {
            if (MessageBox.Show("Bạn có thật sự muốn xóa nhân viên "+ txtDisplayName.Text + " ra khỏi danh sách ?", "Thông báo", MessageBoxButtons.OKCancel) != System.Windows.Forms.DialogResult.Cancel)
            {
        ...
        {
            if (MessageBox.Show("Bạn có thật sự muốn cập nhập thông tin nhân viên " + txtDisplayName.Text , "Thông báo", MessageBoxButtons.OKCancel) != System.Windows.Forms.DialogResult.Cancel)
            {
