...
namespace PBL3_Guna
{
    public partial class UC_Item : UserControl
    {
        ...
        {
            if (MessageBox.Show("Bạn có thật sự muốn xóa món " + txtNameItem.Text+ " ra khỏi menu", "Thông báo", MessageBoxButtons.OKCancel) != System.Windows.Forms.DialogResult.Cancel)
            {
        ...
        {
            if (MessageBox.Show("Bạn có thật sự muốn sửa thông tin món " + txtNameItem.Text + " trong menu", "Thông báo", MessageBoxButtons.OKCancel) != System.Windows.Forms.DialogResult.Cancel)
            {
